...
void ConjuntoPtr::unir(ConjuntoPtr * b, ConjuntoPtr * c) {//borra lo que habia antes en c al unir
	c->reiniciar();
...
void ConjuntoPtr::unionC(ConjuntoPtr *a, ConjuntoPtr *b, ConjuntoPtr *c){
    int r;
	ConjuntoPtr *aux = new ConjuntoPtr();
	// Para insertar a en c
	while (!a->vacio()) {
...
void ConjuntoPtr::interseccion(ConjuntoPtr *a, ConjuntoPtr *b, ConjuntoPtr *c){
    int r;
	ConjuntoPtr* aux = new ConjuntoPtr();
	// Inserto si el elemento pertenece a A y a B
	while (!a->vacio()) {

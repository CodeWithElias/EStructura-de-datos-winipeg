...
using namespace std;
	...
	void menu_matriz_lis_mem();       // reparar codigo todo
	...
	void menu_cola_lis();             // funciona
	void menu_cola_mem();             // funciona
...
void menu_cola_lis(){
	...
	do {
		...
		cout << "1.CREAR COLA\n";
		cout << "2.PONER ELEMENTO\n";
		cout << "3.SACAR ELEMENTO\n";
		cout << "4.PRIMER ELEMENTO\n";
		cout << "5.MOSTRAR COLA\n";
		cout << "6.SALIR\n";
		cout << "Opcion: ";
		cin >> opcion;
